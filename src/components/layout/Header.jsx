...
function Header() {
  return (
    <div className="h-24 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 px-6 py-1.5">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button className="p-2.5 rounded-xl text-slate-600 dark-text-slate-300 hover:bg-slate-100 dark:hover transition-colors">
